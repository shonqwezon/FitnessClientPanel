CREATE OR REPLACE PROCEDURE app.add_plan(in_name VARCHAR(50),
                                        in_base_cost NUMERIC(8, 2),
                                        in_begin_time TIME,
                                        in_end_time TIME,
...
BEGIN
    ...
    INSERT INTO plan (name, base_cost, begin_time, end_time, sportcenter_id)
        VALUES (in_name, in_base_cost, in_begin_time, in_end_time, in_sportcenter_id) RETURNING id INTO new_id;
